...
[xml]$Form = @"
    <Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
       ...
       <Grid>
          ...
          <Label Name="Computer" Content="Computer" HorizontalAlignment="Left" Height="26" Margin="10,41,0,0" VerticalAlignment="Top" Width="69" FontFamily="Segoe UI" Foreground="White"/>
          <Label Name="STime" Content="Start Time" HorizontalAlignment="Left" Height="28" Margin="10,71,0,0" VerticalAlignment="Top" Width="69" FontFamily="Segoe UI" Foreground="White"/>
          <Label Name="Res" Content="Results" HorizontalAlignment="Left" Height="24" Margin="10,114,0,0" VerticalAlignment="Top" Width="92" FontFamily="Segoe UI" Foreground="White" FontWeight="Bold"/>
          ...
          <TextBox Name="Results" HorizontalAlignment="Left" Height="156" Margin="79,141,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="495" BorderBrush="#FFF96816"/>
